...
publication:
  ...
  short_name: "J. Fixed Point Theory Appl."
  volume: 23
  issue: 4
...
abstract: This note discusses some aspects of the asymptotic behaviour of nonexpansive maps. Using metric functionals, we make a connection to the invariant subspace problem and prove a new result for nonexpansive maps of \(\ell_1\). We also point out some inaccurate assertions appearing in the literature on this topic.
...
#  - type: custom
#    label: arxiv
#    url: "https://arxiv.org/pdf/2103.14499"
#  - type: code
